      ...
      return {
        pagination:
          data['hydra:view'] && data['hydra:view']['@id'].includes('page=')
            ? {
                current: data['hydra:view']['@id'].match(/\?page=([0-9]+)/)[1],
                first: data['hydra:view']['hydra:first'].match(
                  /\?page=([0-9]+)/
                )[1],
                last: data['hydra:view']['hydra:last'].match(
                  /\?page=([0-9]+)/
                )[1],
                ...
                next: data['hydra:view']['hydra:next']
                  ? data['hydra:view']['hydra:next'].match(/\?page=([0-9]+)/)[1]
                  : null,
